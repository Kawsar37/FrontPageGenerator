...
public class ProjectProposalInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_project_proposal_info);
        ...
        course_code = (EditText) findViewById(R.id.pp_edit_text_course_code);
        course_title  = (EditText) findViewById(R.id.pp_edit_text_course_title);
        project_title = (EditText) findViewById(R.id.pp_edit_text_project_title);
        team_member1_name = (EditText) findViewById(R.id.pp_team_member1_name);
        team_member1_id = (EditText) findViewById(R.id.pp_team_member1_Id);
        team_member2_name = (EditText) findViewById(R.id.pp_team_member2_name);
        team_member2_id = (EditText) findViewById(R.id.pp_team_member2_Id);
        team_member3_name = (EditText) findViewById(R.id.pp_team_member3_name);
        team_member3_id = (EditText) findViewById(R.id.pp_team_member3_Id);
        team_member4_name = (EditText) findViewById(R.id.pp_team_member4_name);
        team_member4_id = (EditText) findViewById(R.id.pp_team_member4_Id);
        team_batch = (EditText) findViewById(R.id.pp_team_batch);
        team_session = (EditText) findViewById(R.id.pp_team_session);
        file_name = (EditText) findViewById(R.id.pp_edit_text_file_name);
        submit = (Button) findViewById(R.id.pp_submit_button);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (file_name.getText().toString().length() == 0 ||
                        ...
                        project_title.getText().toString().length() == 0 ||
                    ...
                    Toast.makeText(ProjectProposalInfo.this, "Some Info Missing!!!", Toast.LENGTH_LONG).show();
                } else {
                    Intent intent = new Intent(ProjectProposalInfo.this, ProjectProposalSuccess.class);
